...
function(t) {
	...
	o = 0, (a = function(t, e) {
		...
		if (n = document.createDocumentFragment(), r = s.$slider.children(), 0 < s.options.rows) {
		...
		var o, r, t, a = this;
		return t = !0 === a.options.centerMode ? Math.floor(a.$list.width() / 2) : 0, r = -1 * a.swipeLeft + t, !0 === a.options.swipeToSlide ? (a.$slideTrack.find(".slick-slide").each(function(t, e) {
			var i, n;
			if (i = d(e).outerWidth(), n = e.offsetLeft, !0 !== a.options.centerMode && (n += i / 2), r < n + i) return o = e, !1
		...
		if (!0 === r.options.centerMode ? !0 === r.options.infinite ? n = (i = r.currentSlide + (r.options.slidesToShow / 2 + 1)) + r.options.slidesToShow + 2 : (i = Math.max(0, r.currentSlide - (r.options.slidesToShow / 2 + 1)), n = r.options.slidesToShow / 2 + 1 + 2 + r.currentSlide) : (i = r.options.infinite ? r.options.slidesToShow + r.currentSlide : r.currentSlide, n = Math.ceil(i + r.options.slidesToShow), !0 === r.options.fade && (0 < i && i--, n <= r.slideCount && n++)), e = r.$slider.find(".slick-slide").slice(i, n), "anticipated" === r.options.lazyLoad)
			for (var o = i - 1, a = n, s = r.$slider.find(".slick-slide"), l = 0; l < r.options.slidesToScroll; l++) o < 0 && (o = r.slideCount - 1), e = (e = e.add(s.eq(o))).add(s.eq(a)), o--, a++;
		...
		s.length ? (e = s.first(), i = e.attr("data-lazy"), n = e.attr("data-srcset"), o = e.attr("data-sizes") || a.$slider.attr("data-sizes"), (r = document.createElement("img")).onload = function() {
			n && (e.attr("srcset", n), o && e.attr("sizes", o)), e.attr("src", i).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), !0 === a.options.adaptiveHeight && a.setPosition(), a.$slider.trigger("lazyLoaded", [a, e, i]), a.progressiveLazyLoad()
		}, r.onerror = function() {
		...
		if (e = e || !1, !(!0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === t)) return !1 === e && d.asNavFor(t), n = t, l = d.getLeft(n), a = d.getLeft(d.currentSlide), d.currentLeft = null === d.swipeLeft ? a : d.swipeLeft, !1 === d.options.infinite && !1 === d.options.centerMode && (t < 0 || t > d.getDotCount() * d.options.slidesToScroll) ? void(!1 === d.options.fade && (n = d.currentSlide, !0 !== i && d.slideCount > d.options.slidesToShow ? d.animateSlide(a, function() {
			d.postSlide(n)
		}) : d.postSlide(n))) : !1 === d.options.infinite && !0 === d.options.centerMode && (t < 0 || t > d.slideCount - d.options.slidesToScroll) ? void(!1 === d.options.fade && (n = d.currentSlide, !0 !== i && d.slideCount > d.options.slidesToShow ? d.animateSlide(a, function() {
			d.postSlide(n)
...
function(t) {
	...
	t.prototype = {
		...
		open: function(t) {
			...
			if (!u.isOpen) {
				...
				w("BeforeOpen"), u.st.showCloseBtn && (u.st.closeBtnInside ? (b(f, function(t, e, i, n) {
				...
				return u.isIE7 && (d += " mfp-ie7"), d && u._addClassToMFP(d), u.updateItemHTML(), w("BuildControls"), c("html").css(s), u.bgOverlay.add(u.wrap).prependTo(u.st.prependTo || c(document.body)), u._lastFocusedEl = document.activeElement, setTimeout(function() {
					u.content ? (u._addClassToMFP(v), u._setFocus()) : u.bgOverlay.addClass(v), h.on("focusin" + m, u._onFocusIn)
				}, 16), u.isOpen = !0, u.updateSize(a), w(g), t
			}
			u.updateItemHTML()
		},
		close: function() {
			u.isOpen && (w(d), u.isOpen = !1, u.st.removalDelay && !u.isLowIE && u.supportsTransition ? (u._addClassToMFP(i), setTimeout(function() {
				u._close()
		...
		updateItemHTML: function() {
			...
			var e = t.type;
			if (w("BeforeChange", [u.currItem ? u.currItem.type : "", e]), u.currItem = t, !u.currTemplate[e]) {
			...
			u.appendContent(n, e), t.preloaded = !0, w("Change", t), o = t.type, u.container.prepend(u.contentContainer), w("AfterChange")
		},
		appendContent: function(t, e) {
			(u.content = t) ? u.st.showCloseBtn && u.st.closeBtnInside && !0 === u.currTemplate[e] ? u.content.find(".mfp-close").length || u.content.append(k()) : u.content = t: u.content = "", w("BeforeAppend"), u.container.addClass("mfp-" + e + "-holder"), u.contentContainer.append(u.content)
		},
		parseEl: function(t) {
			var e, i = u.items[t];
			if (i.tagName ? i = {
			...
			return i.type = e || u.st.type || "inline", i.index = t, i.parsed = !0, u.items[t] = i, w("ElementParse", i), u.items[t]
		},
		...
		updateStatus: function(t, e) {
			if (u.preloader) {
				...
				w("UpdateStatus", i), t = i.status, e = i.text, u.preloader.html(e), u.preloader.find("a").on("click", function(t) {
		...
		_parseMarkup: function(o, t, e) {
			var r;
			e.data && (t = c.extend(e.data, t)), w(f, [o, t, e]), c.each(t, function(t, e) {
	...
	c.magnificPopup.registerModule(P, {
		...
		proto: {
			initAjax: function() {
				u.types.push(P), _ = u.st.ajax.cursor, b(l + "." + P, D), b("BeforeChange." + P, D)
			},
			getAjax: function(o) {
				...
				var t = c.extend({
					...
					success: function(t, e, i) {
						...
						w("ParseAjax", n), u.appendContent(c(n.data), P), o.finished = !0, A(), u._setFocus(), setTimeout(function() {
							u.wrap.addClass(v)
	...
	c.magnificPopup.registerModule("image", {
		...
		proto: {
			...
			_onImageHasSize: function(t) {
				t.img && (t.hasSize = !0, O && clearInterval(O), t.isCheckingImgSize = !1, w("ImageHasSize", t), t.imgHidden && (u.content && u.content.removeClass("mfp-loading"), t.imgHidden = !1))
			},
				...
				var i = 0,
					...
					o = function(t) {
						O && clearInterval(O), O = setInterval(function() {
							0 < n.naturalWidth ? u._onImageHasSize(e) : (200 < i && clearInterval(O), 3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500))
						}, t)
					};
				o(1)
			},
			getImage: function(t, e) {
				var i = 0,
					n = function() {
						t && (t.img[0].complete ? (t.img.off(".mfploader"), t === u.currItem && (u._onImageHasSize(t), u.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, w("ImageLoadComplete")) : ++i < 200 ? setTimeout(n, 100) : o())
					},
					o = function() {
	...
	c.magnificPopup.registerModule("zoom", {
		...
		proto: {
			...
			_getOffset: function(t) {
				...
				return void 0 === E && (E = void 0 !== document.createElement("p").style.MozTransform), E ? r["-moz-transform"] = r.transform = "translate(" + i.left + "px," + i.top + "px)" : (r.left = i.left, r.top = i.top), r
			}
		}
	});
	var L = "iframe",
		...
		proto: {
			...
			_preloadItem: function(t) {
				if (t = F(t), !u.items[t].preloaded) {
					var e = u.items[t];
					e.parsed || (e = u.parseEl(t)), w("LazyLoad", e), "image" === e.type && (e.img = c('<img class="mfp-img" />').on("load.mfploader", function() {
						e.hasSize = !0
		...
		proto: {
			initRetina: function() {
				if (1 < window.devicePixelRatio) {
					var i = u.st.retina,
						n = i.ratio;
					1 < (n = isNaN(n) ? n() : n) && (b("ImageHasSize." + W, function(t, e) {
						e.img.css({
...
function(i) {
	...
	t.prototype.options = {
		...
		var i = "",
			n = function(t) {
				var e = "",
					i = "",
					n = "";
				!t.selectedOpt || this.foundSelected || this.hasDefaultPlaceholder || (i += "cs-selected ", this.foundSelected = !0), t.getAttribute("data-class") && (i += t.getAttribute("data-class")), t.getAttribute("data-link"), "" !== i && (e = 'class="' + i + '" ');
				var o = "";
		...
		e && classie.remove(e, "cs-selected"), classie.add(t, "cs-selected"), t.getAttribute("data-link") && (i.location = t.getAttribute("data-link")), this.options.onChange(this.el.value)
	...
	function S(t) {
		if (function() {
				if (!k) {
					...
					e.appendChild(t);
					var i = x(t);
					w = 200 == Math.round(v(i.width)), S.isBoxSizeOuter = w, e.removeChild(t)
				}
...
function(a, s) {
	...
	d.sortDataParsers = {
		...
		if (this.options.sortBy) {
			...
			var l, d, e = (l = this.sortHistory, d = this.options.sortAscending, function(t, e) {
					...
					update: function(i) {
						...
						if (h < 2 * Math.PI) {
							var p = o.rotation % (2 * Math.PI),
								...
								w = p <= -Math.PI && -Math.PI <= f || p <= Math.PI && Math.PI <= f,
								k = p <= .5 * -Math.PI && .5 * -Math.PI <= f || p <= 1.5 * Math.PI && 1.5 * Math.PI <= f,
								S = u / 100,
								C = w ? -1 : Math.min(g * (g < 0 ? 1 : S), v * (v < 0 ? 1 : S)),
								T = k ? -1 : Math.min(m * (m < 0 ? 1 : S), y * (y < 0 ? 1 : S)),
								I = b ? 1 : Math.max(g * (0 < g ? 1 : S), v * (0 < v ? 1 : S)),
								M = x ? 1 : Math.max(m * (0 < m ? 1 : S), y * (0 < y ? 1 : S)),
								_ = .5 * (I - C),
								P = .5 * (M - T);
							l = Math.min(a / _, s / P), d = {
								x: -.5 * (I + C),
								y: -.5 * (M + T)
							}
						}
			...
			e.exports = function(t) {
				...
				t.layoutService = {
					...
					update: function(e, i, t) {
						...
						function o(t) {
							t.isHorizontal() ? (t.left = t.options.fullWidth ? s : C, t.right = t.options.fullWidth ? i - l : C + w, t.top = D, t.bottom = D + t.height, D = t.bottom) : (t.left = A, t.right = A + t.width, t.top = I, t.bottom = I + k, A = t.right)
						}
						if (e) {
							...
							var C = s,
								...
								I = d,
								M = c;
							O.each(u.concat(h), n), O.each(u, function(t) {
								C += t.width
							}), O.each(h, function(t) {
								T += t.width
							}), O.each(p.concat(f), n), O.each(p, function(t) {
								I += t.height
							}), O.each(f, function(t) {
								M += t.height
							...
							}), C = s, T = l, I = d, M = c, O.each(u, function(t) {
								C += t.width
							}), O.each(h, function(t) {
								T += t.width
							}), O.each(p, function(t) {
							...
							var A = s,
								D = d;
							O.each(u.concat(p), o), A += w, D += k, O.each(h, o), O.each(f, o), e.chartArea = {
								left: C,
								top: I,
								right: C + w,
								bottom: I + k
				...
				T.defaults.global.legend = {
					...
					labels: {
						...
						generateLabels: function(i) {
							var t = i.data;
							return M.isArray(t.datasets) ? t.datasets.map(function(t, e) {
								return {
									text: t.label,
									fillStyle: M.isArray(t.backgroundColor) ? t.backgroundColor[0] : t.backgroundColor,
					...
					initialize: function(t) {
						M.extend(this, t), this.legendHitBoxes = [], this.doughnutMode = !1
					},
					beforeUpdate: t,
					...
					fit: function() {
						...
						if (p ? (h.width = n.maxWidth, h.height = e ? 10 : 0) : (h.width = e ? 10 : 0, h.height = n.maxHeight), e)
							if (r.font = c, p) {
								...
								r.textAlign = "left", r.textBaseline = "top", M.each(n.legendItems, function(t, e) {
								...
								M.each(n.legendItems, function(t, e) {
									var i = I(o, s) + s / 2 + r.measureText(t.text).width;
									x + w > h.height && (y += b + o.padding, v.push(b), x = b = 0), b = Math.max(b, i), x += w, u[e] = {
										left: 0,
										top: 0,
										width: i,
										height: s
								...
								S ? g <= l + s && (d = v.y += C, v.line++, l = v.x = c.left + (g - m[v.line]) / 2) : d + C > c.bottom && (l = v.x = l + c.columnWidths[v.line] + h.padding, d = v.y = c.top, v.line++),
									function(t, e, i) {
										if (!(isNaN(w) || w <= 0)) {
											...
											} else n || y.strokeRect(t, e, w, x), y.fillRect(t, e, w, x);
											y.restore()
										}
									}(l, d, t), k[e].left = l, k[e].top = d, i = l, n = d, o = t, r = a, y.fillText(o.text, w + x / 2 + i, n), o.hidden && (y.beginPath(), y.lineWidth = 2, y.moveTo(w + x / 2 + i, n + x / 2), y.lineTo(w + x / 2 + i + r, n + x / 2), y.stroke()), S ? v.x += s + h.padding : v.y += C
							})
						}
					},
					handleEvent: function(t) {
				...
				j.defaults.scale = {
					...
					fit: function() {
						...
						if (e.width = l ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : s && a.drawTicks ? f : 0, e.height = l ? s && a.drawTicks ? f : 0 : t.maxHeight, r.display && s && (l ? e.height += 1.5 * p : e.width += 1.5 * p), o.display && s) {
							...
							if (l) {
								...
								t.paddingLeft = 0 !== t.labelRotation ? w * b + 3 : b / 2 + 3, t.paddingRight = 0 !== t.labelRotation ? k * (d / 2) + 3 : x / 2 + 3
							} else {
					...
					draw: function(b) {
						...
						if (w.display) {
							...
							var D = [];
							if (I) {
								if (k = !1, T && (m /= 2), (m + S.autoSkipPadding) * x.ticks.length > x.width - (x.paddingLeft + x.paddingRight) && (k = 1 + Math.floor((m + S.autoSkipPadding) * x.ticks.length / (x.width - (x.paddingLeft + x.paddingRight)))), t && x.ticks.length > t)
							...
							if ($.each(x.ticks, function(t, e) {
									if (null != t) {
										...
										if ((!(1 < k && 0 < e % k || e % k == 0 && e + k >= x.ticks.length) || i) && null != t) {
											...
											var r, a, s, l, d, c, u, h, p, f, g = "middle",
												m = "middle";
											if (I) {
												T || (m = "top" === w.position ? "bottom" : "top"), g = T ? "right" : "center";
												var v = x.getPixelForTick(e) + $.aliasPixel(n);
												p = x.getPixelForTick(e, C.offsetGridLines) + S.labelOffset, f = T ? x.top + 12 : "top" === w.position ? x.bottom - M : x.top + M, r = s = d = u = v, a = L, l = z, c = b.top, h = b.bottom
											} else {
												"left" === w.position ? S.mirror ? (p = x.right + S.padding, g = "left") : (p = x.right - S.padding, g = "right") : S.mirror ? (p = x.left - S.padding, g = "right") : (p = x.left + S.padding, g = "left");
												var y = x.getPixelForTick(e);
												y += $.aliasPixel(n), f = x.getPixelForTick(e, C.offsetGridLines), r = O, s = E, d = b.left, u = b.right, a = l = c = h = y
											}
											D.push({
												tx1: r,
												ty1: a,
								...
								var v, y, F = 0;
								if (I) v = x.left + (x.right - x.left) / 2, y = "bottom" === w.position ? x.bottom - u / 2 : x.top + u / 2;
								else {
							...
							if (C.drawBorder) {
								...
								I ? (H = V = "top" === w.position ? x.bottom : x.top, H += N, V += N) : (W = B = "left" === w.position ? x.right : x.left, W += N, B += N), o.beginPath(), o.moveTo(W, H), o.lineTo(B, V), o.stroke()
							}
						}
					}
				})
				...
				E.defaults.global.tooltips = {
					...
					update: function(t) {
						...
						if (C.length) {
							S.opacity = 1;
							var D = [];
							A = E.Tooltip.positioners[w.position](C, x._eventPosition);
							var O = [];
							for (e = 0, i = C.length; e < i; ++e) O.push((g = C[e], v = m = void 0, m = g._xScale, v = g._yScale || g._scale, y = g._index, b = g._datasetIndex, {
							...
							}), S.title = x.getTitle(O, T), S.beforeBody = x.getBeforeBody(O, T), S.body = x.getBody(O, T), S.afterBody = x.getAfterBody(O, T), S.footer = x.getFooter(O, T), S.x = Math.round(A.x), S.y = Math.round(A.y), S.caretPadding = z.getValueOrDefault(A.padding, 2), S.labelColors = D, S.dataPoints = O, M = function(t, e) {
								var i = t._model,
									n = t._chart,
							...
							}(this, S)), o = P, r = M, a = (n = S).x, s = n.y, l = n.caretSize, d = n.caretPadding, c = n.cornerRadius, u = r.xAlign, h = r.yAlign, p = l + d, f = c + d, "right" === u ? a -= o.width : "center" === u && (a -= o.width / 2), "top" === h ? s += p : s -= "bottom" === h ? o.height + p : o.height / 2, "center" === h ? "left" === u ? a += p : "right" === u && (a -= p) : "left" === u ? a -= f : "right" === u && (a += f), _ = {
								x: a,
								y: s
							}
						} else S.opacity = 0;
						return S.xAlign = M.xAlign, S.yAlign = M.yAlign, S.x = _.x, S.y = _.y, S.width = P.width, S.height = P.height, S.caretX = A.x, S.caretY = A.y, x._model = S, t && w.custom && w.custom.call(x, S), x
					},
							...
							if (d.display) {
								...
								if (S.each(l.ticks, function(t, e) {
									...
									for (var o = l.getDistanceFromCenterForValue(d.reverse ? l.min : l.max), r = h(e.fontSize, C.defaultFontSize), a = h(e.fontStyle, C.defaultFontStyle), s = h(e.fontFamily, C.defaultFontFamily), m = S.fontString(r, a, s), v = l.getValueCount() - 1; 0 <= v; v--) {
										...
										p.textAlign = 0 === k || 180 === k ? "center" : k < 180 ? "left" : "right", p.textBaseline = 90 === k || 270 === k ? "middle" : 270 < k || k < 90 ? "bottom" : "top", p.fillText(w[v] ? w[v] : "", b.x, b.y)
									}
								}
							}
						}
					...
					t = b.Scale.extend({
						...
						buildTicks: function() {
							...
							if (t.ctx.font = r, t.ticks = [], t.unitScale = 1, t.scaleSizeInUnits = 0, t.options.time.unit) t.tickUnit = t.options.time.unit || "day", t.displayFormat = t.options.time.displayFormats[t.tickUnit], t.scaleSizeInUnits = t.lastTick.diff(t.firstTick, t.tickUnit, !0), t.unitScale = x.getValueOrDefault(t.options.time.unitStepSize, 1);
								...
								for (var c = 0, u = w.units[c]; c < w.units.length;) {
...
function(t) {
	...
	function p(t, e) {
		if (e = j(e), !Array.isArray(e) || !e.length) throw new Error("noUiSlider: 'start' option is incorrect.");
	...
	function S(t, e) {
		if (!1 !== e)
			if (!0 === e) {
				...
				if (t.tooltips = j(e), t.tooltips.length !== t.handles) throw new Error("noUiSlider: must pass a formatter for all handles.");
	...
	function _(t, h, r) {
		...
		function i(t) {
			var p, f, g, m, e, i, v, y, b, n = t.mode,
				...
				s = (p = o, f = n, g = a, m = {}, e = W.xVal[0], i = W.xVal[W.xVal.length - 1], y = v = !1, b = 0, (g = g.slice().sort(function(t, e) {
					return t - e
				}).filter(function(t) {
					...
					var i, n, o, r, a, s, l, d, c, u = t,
						h = g[e + 1];
					if ("steps" === f && (i = W.xNumSteps[e]), i || (i = h - u), !1 !== u && void 0 !== h)
						for (i = Math.max(i, 1e-7), n = u; n <= h; n = (n + i).toFixed(7) / 1) {
							for (l = (a = (r = W.toStepping(n)) - b) / p, c = a / (d = Math.round(l)), o = 1; o <= d; o += 1) m[(b + o * c).toFixed(5)] = ["x", 0];
		...
		function c(t) {
			var e, i, n, o, r, a = 100 * (t - (e = M, i = h.ort, n = e.getBoundingClientRect(), o = e.ownerDocument.documentElement, r = U(), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (r.x = 0), i ? n.top + r.y - o.clientTop : n.left + r.x - o.clientLeft)) / s();
		...
		function m(t, e) {
			...
			if (document.documentElement.noUiListeners = n.concat(o, r), t.cursor) {
				document.body.style.cursor = getComputedStyle(t.target).cursor, 1 < _.length && $(z, h.cssClasses.drag);
				var a = function() {
					return !1
				};
		...
		function o(t) {
			...
			var n, o, r, e = c(t.calcPoint),
				i = (n = e, r = !(o = 100), _.forEach(function(t, e) {
					if (!t.hasAttribute("disabled")) {
						var i = Math.abs(F[e] - n);
						i < o && (r = e, o = i)
					}
				}), r);
			return !1 !== i && (h.events.snap || N(z, h.cssClasses.tap, h.animationDuration), w(i, e, !0, !0), x(), u("slide", i, !0), u("set", i, !0), u("change", i, !0), u("update", i, !0), void(h.events.snap && m(t, {
				handleNumbers: [i]
			})))
		}
		...
		function v(t) {
			var e = c(t.calcPoint),
				...
				n = W.fromStepping(i);
			Object.keys(H).forEach(function(t) {
				"hover" === t.split(".")[0] && H[t].forEach(function(t) {
					t.call(A, n)
				})
			})
		}
		...
		function y(t, e, i, n, o) {
			return 1 < _.length && (n && 0 < e && (i = Math.max(i, t[e - 1] + h.margin)), o && e < _.length - 1 && (i = Math.min(i, t[e + 1] - h.margin))), 1 < _.length && h.limit && (n && 0 < e && (i = Math.min(i, t[e - 1] + h.limit)), o && e < _.length - 1 && (i = Math.max(i, t[e + 1] - h.limit))), i = W.getStep(i), r = i, (i = Math.max(Math.min(r, 100), 0)) !== t[e] && i;
			var r
		}
		...
		function S(t, e) {
			null !== t && !1 !== t && ("number" == typeof t && (t = String(t)), !1 === (t = h.format.from(t)) || isNaN(t) || w(e, W.toStepping(t), !1, !1))
		}

		function C(t, e) {
			var i = j(t),
				n = void 0 === F[0];
			e = void 0 === e || !!e, i.forEach(S), h.animate && !n && N(z, h.cssClasses.tap, h.animationDuration), R.forEach(function(t) {
				w(t, F[t], !0, !1)
		...
		function I(t, e) {
			H[t] = H[t] || [], H[t].push(e), "update" === t.split(".")[0] && _.forEach(function(t, e) {
				u("update", e)
			})
		}
		var M, _, P, A, D, O, E, L = window.navigator.pointerEnabled ? {
				start: "pointerdown",
				move: "pointermove",
				end: "pointerup"
		...
		return $(E = z, h.cssClasses.target), 0 === h.dir ? $(E, h.cssClasses.ltr) : $(E, h.cssClasses.rtl), 0 === h.ort ? $(E, h.cssClasses.horizontal) : $(E, h.cssClasses.vertical), M = V(E, h.cssClasses.base),
			function(t, e) {
				_ = [], (P = []).push(a(e, t[0]));
				for (var i = 0; i < h.handles; i++) _.push((n = i, V(o = V(e, h.cssClasses.origin), h.cssClasses.handle).setAttribute("data-handle", n), o)), R[i] = i, P.push(a(e, t[i + 1]));
				var n, o
			}(h.connect, M), A = {
				destroy: function() {
				...
				updateOptions: function(e, t) {
					...
					n.forEach(function(t) {
						void 0 !== e[t] && (h[t] = o[t])
					}), o.spectrum.direction = W.direction, W = o.spectrum, h.margin = o.margin, h.limit = o.limit, F = [], C(e.start || i, t)
				},
				target: z,
				pips: i
			}, (O = h.events).fixed || _.forEach(function(t, e) {
				l(L.start, t.children[0], m, {
					handleNumbers: [e]
				})
			}), O.tap && l(L.start, M, o, {}), O.hover && l(L.move, M, v, {
				hover: !0
			}), O.drag && P.forEach(function(t, e) {
				if (!1 !== t && 0 !== e && e !== P.length - 1) {
					var i = _[e - 1],
						n = _[e],
						o = [t];
					$(t, h.cssClasses.draggable), O.fixed && (o.push(i.children[0]), o.push(n.children[0])), o.forEach(function(t) {
						l(L.start, t, m, {
							handles: [i, n],
							handleNumbers: [e - 1, e]
						})
			...
			}), C(h.start), h.pips && i(h.pips), h.tooltips && (D = _.map(e), I("update", function(t, e, i) {
				if (D[e]) {
					var n = t[e];
